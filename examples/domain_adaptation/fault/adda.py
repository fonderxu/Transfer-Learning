...
from dalib.adaptation.adda import FaultClassifier, DomainAdversarialLoss
...
def main(args: argparse.Namespace):
    ...
    optimizer_d = Adam(domain_discri.get_parameters(), args.lr, weight_decay=args.weight_decay)
...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator, model: FaultClassifier,
    ...
    for i in range(args.iters_per_epoch):
        ...
        d_s = domain_discri(gl(f_s))
        d_t = domain_discri(gl(f_t))
        ...
        d_s = domain_discri(f_s.detach())
        d_t = domain_discri(f_t.detach())
