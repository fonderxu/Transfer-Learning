...
def main(args: argparse.Namespace):
    ...
    if args.phase == 'analysis':
        ...
        mmd_loss = utils.mmd_linear(source_feature, target_feature)
...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator, model: FaultClassifier,
    ...
    model.train()
    alpha = 1. / (epoch + 1) if epoch <= 5 else 0.
    t_output_distribution = 1. / (1. + alpha) * (alpha * s_label_distribution + t_output_distribution)
